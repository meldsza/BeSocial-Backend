                ...
                <table class="table dataTable my-0" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $value->phone }}</td>
                            <td>{{ $value->points }}</td>
                            <td><a class="warnban"><i class="text-center btn-warning fa fa-exclamation-circle"
                                        data-toggle="tooltip" data-placement="top" title="Warn" aria-hidden="true"></i>
                                </a>
                                <a class="warnban"><i class="text-center btn-danger fa fa-ban" aria-hidden="true"
                                        data-toggle="tooltip" data-placement="top" title="Ban"></i>
                                </a>
                            </td>
                        </tr>
                        @endforeach
