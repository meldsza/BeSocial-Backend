...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>BeSocial</span></div>
                </a>
                <hr class="sidebar-divider my-0">
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link @yield('nav-dash')" href="/admin/"><i
                                class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link @yield('nav-users')"
                            href="/admin/users"><i class="fas fa-table"></i><span>Users</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link @yield('nav-quest')"
                            href="/admin/quests"><i class="fas fa-table"></i><span>Quest</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link @yield('nav-categories')"
                            href="/admin/categories"><i class="far fa-user-circle"></i><span>Categories</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link @yield('nav-ngo')"
                            href="/admin/ngoapplication"><i class="far fa-user-circle"></i><span>NGO
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-list dropdown-menu-right animated--grow-in"
                                        ...
                                        <a class="d-flex align-items-center dropdown-item" href="#">
                                            <div class="dropdown-list-image mr-3"><img class="rounded-circle"
                                                    src={{asset('assets1/img/avatars/avatar4.jpeg')}}>
                                        ...
                                        <a class="d-flex align-items-center dropdown-item" href="#">
                                            <div class="dropdown-list-image mr-3"><img class="rounded-circle"
                                                    src={{asset('assets1/img/avatars/avatar2.jpeg')}}>
                                        ...
                                        <a class="d-flex align-items-center dropdown-item" href="#">
                                            <div class="dropdown-list-image mr-3"><img class="rounded-circle"
                                                    src={{asset('assets1/img/avatars/avatar3.jpeg')}}>
                                        ...
                                        <a class="d-flex align-items-center dropdown-item" href="#">
                                            <div class="dropdown-list-image mr-3"><img class="rounded-circle"
                                                    src={{asset('assets1/img/avatars/avatar5.jpeg')}}>
                                                <div class="bg-success status-indicator"></div>
                                            </div>
                                            <div class="font-weight-bold">
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                        data-toggle="dropdown" aria-expanded="false" href="#"><span
                                            ...
                                            src={{asset('assets1/img/avatars/avatar1.jpeg')}}></a>
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © BeSocial 2020</span></div>
                </div>
            </footer>
    ...
    <script src="{{asset('assets1/js/script.min.js')}}"></script>
    <script>
        $(function () {
